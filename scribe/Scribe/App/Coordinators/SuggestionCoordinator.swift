...
/// File overview:
/// Declares the shared state and dependency graph for Jot's inline-completion orchestrator.
...
final class SuggestionCoordinator: ObservableObject {
    ...
    /// True while Jot keeps the accept tap owning Tab in the gap between a final-chunk accept and
