...
/// File overview:
/// Builds Jot's long-lived dependency graph in one place. This is the app's composition model:
...
final class ScribeAppEnvironment {
    ...
    init() {
        ...
        let focusModel = FocusTrackingModel(
            ...
            // The Context pane's live-preview field is the single sanctioned spot where Jot may
