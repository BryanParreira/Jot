...
/// and `Tab` acceptance. This is the boundary between raw CGEvents and Jot's smaller
...
///
/// `notHandled` means the key was not one of Jot's configured accept keys. `passThrough`
...
final class InputMonitor {
    ...
    func handleAcceptTap(type: CGEventType, event: CGEvent) -> Unmanaged<CGEvent>? {
        ...
        case .keyDown:
            ...
            // it recognizes Jot's synthetic insertion events by identity instead. Without this an
