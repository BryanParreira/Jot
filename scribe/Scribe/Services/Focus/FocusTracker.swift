...
final class FocusTracker {
    ...
    /// AX identifier of the one element inside Jot's own UI that is allowed to be captured: the
    ...
    /// element in Jot's windows stays blocked.
    ...
    private func captureSnapshot() -> FocusCaptureResult {
        ...
        // pipeline against their settings. Every other element in Jot's own windows (search field,
