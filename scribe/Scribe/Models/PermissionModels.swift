...
/// File overview:
/// Centralizes Jot's permission metadata in one place.
///
...
nonisolated enum PermissionGuidanceStyle: Equatable, Sendable {
    /// Launch System Settings and show Jot's drag-and-drop helper overlay.
    case guidedOverlay
...
/// Describes one macOS privacy permission Jot can request.
///
