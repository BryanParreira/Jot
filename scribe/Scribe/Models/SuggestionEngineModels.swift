...
/// File overview:
/// Defines the product-facing engine choices for Jot's autocomplete pipeline.
...
struct SuggestionSettingsSnapshot: Equatable, Sendable {
    ...
    /// gate sees the live value alongside the other "where Jot runs" rules.
    ...
    /// User-authored profile data for Jot's base-model completion prompt.
