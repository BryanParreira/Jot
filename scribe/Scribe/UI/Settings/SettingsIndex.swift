...
enum SettingsItem: String, CaseIterable, Identifiable {
    ...
    var title: String {
        ...
        case .toggleTabby: return "Toggle Scribe"
        ...
        case .support: return "Support Scribe"
    ...
    var summary: String {
        switch self {
        case .enableGlobally: return "Turn Scribe on or off everywhere without quitting."
        case .fastMode: return "Skip screenshot context for faster suggestions."
        case .openAtLogin: return "Start Scribe automatically when you log in."
        ...
        case .resetAllSettings: return "Restore every Scribe setting to its original default."
        ...
        case .length: return "How many words Scribe aims for per suggestion."
        case .name: return "What Scribe should call you."
        ...
        case .toggleTabby: return "A global hotkey that turns Scribe on or off."
        case .disabledApps: return "Apps where Scribe never autocompletes."
        ...
        case .checkForUpdates: return "See if a newer version is available."
        case .support: return "Support the Scribe project."
        case .githubRepository: return "Browse the source code and issues."
        case .wiki: return "Documentation and the contributor guide."
        case .acknowledgements: return "Third-party packages Scribe ships with."
        case .uninstall: return "Remove Scribe and its data from this Mac."
        }
    }
