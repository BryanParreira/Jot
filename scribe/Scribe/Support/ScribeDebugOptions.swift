...
nonisolated enum JotLogger {
    ...
    static let app = Logger(label: "com.bryanbernardo.scribe.app")
    static let debug = Logger(label: "com.bryanbernardo.scribe.debug")
    static let runtime = Logger(label: "com.bryanbernardo.scribe.runtime")
    static let focus = Logger(label: "com.bryanbernardo.scribe.focus")
    static let updates = Logger(label: "com.bryanbernardo.scribe.updates")
