#!/usr/bin/env python3
"""Build a styled release DMG for Scribe.
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Build a styled Scribe release DMG with dmgbuild."
    )
    parser.add_argument(
        "--app-path",
        required=True,
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="Scribe-dmgbuild-") as temporary_root:
